...
#Create plot plot area
par(mfrow=c(2,2))

#Create plot 1
plot(date_time,pwr$Global_active_power,type="l",xlab="",ylab="Global Active Power")

#Create plot 2
plot(date_time,pwr$Voltage,type="l",xlab="datetime",ylab="Voltage")
...
#Create plot 4
plot(date_time,pwr$Global_reactive_power,type="l",xlab="datetime",ylab="Global Rective Power")
